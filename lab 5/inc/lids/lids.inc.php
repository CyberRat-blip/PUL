				...
				<nav class="navbar navbar-expand-md sticky-top navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item active">
								<a class="nav-link" href="../../index.php">Отзывы <span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item active">	
								<a class="nav-link" href="lids.inc.php">Спец предложения <span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item active">	
